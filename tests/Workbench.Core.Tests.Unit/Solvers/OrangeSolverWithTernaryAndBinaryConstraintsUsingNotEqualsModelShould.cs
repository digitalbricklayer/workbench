...
{
    [TestFixture]
    public class OrangeSolverWithTernaryAndBinaryConstraintsUsingNotEqualsModelShould
    {
        [Test]
        ...
        public void SolveReturningLabelInValidRange()
        {
            ...
            Assert.That(xLabel.Value, Is.AnyOf(1, 2));
            Assert.That(yLabel.Value, Is.AnyOf(1, 2));
        }
