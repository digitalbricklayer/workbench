...
namespace Workbench.Core.Tests.Unit.Models
{
    ...
    public class ExpressionConstraintModelTests
    {
        ...
        {
            var sut = new ExpressionConstraintModel(new ConstraintExpressionModel("$x > 1"));
        ...
        {
            var sut = new ExpressionConstraintModel(new ConstraintExpressionModel("     $a1    >    999      "));
        ...
        {
            var sut = new ExpressionConstraintModel(new ConstraintExpressionModel("$y <= 44"));
        ...
        {
            var sut = new ExpressionConstraintModel(new ConstraintExpressionModel("$y = $x"));
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new ExpressionConstraintModel((ModelName) null));
        }

        [Test]
        public void InitializeWithRawExpressionParsesExpectedAggregateVariableNameOnLeft()
        {
            var sut = new ExpressionConstraintModel(new ConstraintExpressionModel("$xx[1] > 1"));
        ...
        {
            var sut = new ExpressionConstraintModel(new ConstraintExpressionModel("$x[1] > $x[2]"));
