...
namespace Workbench.Core.Tests.Unit.Models
{
    ...
    public class SingletonVariableModelTests
    {
        ...
        {
            var sut = new SingletonVariableGraphicModel(new SingletonVariableModel(new ModelModel(), new ModelName("x")));
        ...
        {
            var sut = new SingletonVariableGraphicModel(new SingletonVariableModel(new ModelModel(), new ModelName("x"), new VariableDomainExpressionModel()));
        ...
        {
            var sut = new SingletonVariableGraphicModel(new SingletonVariableModel(new ModelModel(), new ModelName("x"), new VariableDomainExpressionModel("   $A    ")));
        ...
        {
            var sut = new SingletonVariableGraphicModel(new SingletonVariableModel(new ModelModel(), new ModelName("x"), new VariableDomainExpressionModel("1..10")));
