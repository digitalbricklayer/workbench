...
namespace Workbench.UI.Tests.Unit.ViewModels
{
    ...
    public class DomainViewModelTests
    {
        ...
        {
            var sut = new DomainViewModel(new DomainGraphicModel("X", "1..2"));
        ...
        {
            var sut = new DomainViewModel(new DomainGraphicModel("X", string.Empty));
        ...
        {
            var sut = new DomainViewModel(new DomainGraphicModel());
