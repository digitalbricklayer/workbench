...
namespace Workbench.ViewModels
{
    ...
    /// </summary>
    public sealed class AllDifferentConstraintExpressionEditorViewModel : PropertyChangedBase
    {
        private bool isExpressionEditing;

        public AllDifferentConstraintExpressionEditorViewModel(AllDifferentConstraintExpressionModel theExpressionModel)
        {
