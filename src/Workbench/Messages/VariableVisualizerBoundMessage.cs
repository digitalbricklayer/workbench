...
namespace Workbench.Messages
{
    ...
    /// </summary>
    public class VariableVisualizerBoundMessage
    {
        /// <summary>
        ...
        public VariableVisualizerBoundMessage(VariableVisualizerModel theVisualizer,
        ...
        /// </summary>
        public VariableVisualizerModel Visualizer { get; private set; }
